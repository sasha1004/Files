...
$.widget("ech.multiselect", {
	...
	refresh: function( init ){
		...
		this.element.find('option').each(function( i ){
			var $this = $(this), 
				...
				value = this.value,
				inputID = this.id ? 's'+this.id : 'ui-multiselect-'+id+'-option-'+i,
			...
			html.push('<input id="'+inputID+'" name="'+id+'['+this.id+']" type="'+(o.multiple ? "checkbox" : "radio")+'" value="'+value+'" title="'+title+'"');
	...
	_setButtonWidth: function(){
		...
		// set widths
		this.button.width(this.options.width);
	},
